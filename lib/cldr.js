...
function camelCase(str) {
    return str.replace(/-([a-z])/g, function ($0, ch) { // stand-alone => standAlone
...
Cldr.prototype = {
    ...
    extractQuarterNames: function (localeId, calendarId) {
        ...
        ['format', 'stand-alone'].forEach(function (quarterContext) {
            var quarterContextCamelCase = camelCase(quarterContext);
    ...
    extractListPatterns: function (localeId) {
        ...
        finder("/ldml/listPatterns/listPattern/listPatternPart").forEach(function (listPatternPartNode) {
            var listPatternTypeAttribute = listPatternPartNode.parent().attr('type'),
                type = listPatternTypeAttribute ? camelCase(listPatternTypeAttribute.value()) : 'default',
