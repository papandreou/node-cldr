...
Cldr.prototype = {
    ...
    expandLocaleIdToPrioritizedList: function(localeId) {
        ...
        while (/_[^_]+$/.test(localeId)) {
            Object.keys(this.localesByParentLocale).forEach(function (parentLocale) {
                if (this.localesByParentLocale[parentLocale].indexOf(localeId) > -1) {
                    localeIds.push(parentLocale);
                }
            }, this);
