...
cldr.extractLocaleDataFromXmlString = function (xmlString, cb) {
    ...
    document.find("/ldml/dates/calendars/calendar[@type='gregorian']/fields/field/displayName").forEach(function (fieldDisplayNameNode) {
        ...
        localeData.fields[fieldName] = localeData.fields[fieldName] || {};
        localeData.fields[fieldName].displayName = localeData.fields[fieldName].displayName || fieldDisplayNameNode.text();
    });

    document.find("/ldml/dates/calendars/calendar[@type='gregorian']/fields/field/relative").forEach(function (fieldRelativeNode) {
        var fieldName = fieldRelativeNode.parent().attr('type').value(),
            type = fieldRelativeNode.attr('type').value();
        localeData.fields[fieldName] = localeData.fields[fieldName] || {};
        localeData.fields[fieldName].relative = localeData.fields[fieldName].relative || {};
        localeData.fields[fieldName].relative[type] = localeData.fields[fieldName].relative[type] || fieldRelativeNode.text();
