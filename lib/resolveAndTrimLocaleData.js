...
module.exports = function resolveAndTrimLocaleData(localeData, options) {
    ...
    if (options.localeInfo && localeData.localeDisplayNames) {
        localeData.localeInfo = Object.keys(localeData.localeDisplayNames).filter(function (localeId) {
            return !options.localeInfoIncludedOnly || options.targetLocaleIds.indexOf(localeId) !== -1;
    ...
    if (options.timeZoneInfo && localeData.timeZoneDisplayNames) {
    ...
    if (options.countryInfo && localeData.territoryDisplayNames) {
    ...
    if (options.regionInfo && localeData.territoryDisplayNames) {
