...
function convertObjectsWithIntegerKeysToArrays(obj) {
...
Cldr.prototype = {
    ...
    _extractTimeZoneDisplayNames: function (finder) {
    ...
    _extractTimeZoneFormats: function (finder) {
        var timeZoneFormats = {};
    ...
    _extractTerritoryDisplayNames: function (options, finder) {
    ...
    _extractDefaultNumberSystemId: function (finder) {
    ...
    _extractUnitPatterns: function (finder) {
        var unitPatterns = {};
    ...
    _extractDelimiters: function (finder) {
        var delimiters = {};
    ...
    _extractListPatterns: function (finder) {
        var listPatterns = {};
    ...
    _extractCharacters: function (finder) {
        var characters = {
            exemplar: {},
            ellipsis: {}
        };
    ...
    extractDataForLocale: function (options, cb) {
        ...
        that.getPrioritizedDocumentsForLocale(options.localeId, 'main', passError(cb, function (prioritizedDocuments) {
            ...
            if (options.defaultNumberSystemId) {
                localeData.defaultNumberSystemId = that._extractDefaultNumberSystemId(finder);
            }
            ...
            if (options.unitPatterns) {
                localeData.unitPatterns = that._extractUnitPatterns(finder);
            }

            if (options.delimiters) {
                localeData.delimiters = that._extractDelimiters(finder);
            }

            if (options.listPatterns) {
                localeData.listPatterns = that._extractListPatterns(finder);
            }

            if (options.characters) {
                localeData.characters = that._extractCharacters(finder);
            }

            if (options.timeZoneDisplayNames) {
                localeData.timeZoneDisplayNames = that._extractTimeZoneDisplayNames(finder);
            }

            if (options.timeZoneFormats) {
                localeData.timeZoneFormats = that._extractTimeZoneFormats(finder);
            }

            if (options.territoryDisplayNames) {
                localeData.territoryDisplayNames = that._extractTerritoryDisplayNames(options, finder);
            }
            ...
            seq()
                ...
                .seq(function () {
                    cb(null, convertObjectsWithIntegerKeysToArrays(localeData));
                });
        }));
    },
