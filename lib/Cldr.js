    ...
    extractDataForLocale: function (options, cb) {
        ...
        seq(expandLocaleIdToPrioritizedList(options.localeId).concat('root'))
            ...
            .seq(function (prioritizedDocuments) {
                ...
                if (options.calendars || options.eraNames || options.quarterNames || options.monthNames || options.monthPatterns || options.dayNames || options.dayPeriods || options.dateFormats || options.dateIntervalFormats || options.fields) {
