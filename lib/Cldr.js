...
Cldr.prototype = {
    ...
    _extractCurrencies: function (options, finder) {
        ...
        finder("/ldml/numbers/currencies/currency/displayName").forEach(function (currencyDisplayNameNode) {
        ...
        that.getPrioritizedDocumentsForLocale(options.localeId, 'main', passError(cb, function (prioritizedDocuments) {
            ...
            seq()
                .seq(function () {
                    var callback = this;
                    if (options.rbnf) {
                        that.getRbnfFunctionByType(options.localeId, passError(callback, function (rbnfFunctionByType) {
    ...
    getRbnfFunctionByType: function (localeId, cb) {
        var that = this;
        that.getPrioritizedDocumentsForLocale(localeId, 'rbnf', passError(cb, function (prioritizedDocuments) {
            ...
            var isAddedByType = {},
                typesToAdd = ['renderDigitsOrdinal', 'renderSpelloutNumbering'],
                rbnfFunctionByType = {};
