...
Cldr.prototype = {
    ...
    _extractNumberSystem: function (numberSystemId, find) {
        var numberSystem = {
            symbols: {},
            formats: {}
        };
        ...
        ['scientific', 'decimal', 'currency', 'percent'].forEach(function (formatType) {
            ['full', 'long', 'medium', 'short'].forEach(function (length) {
                find("/ldml/numbers/" + formatType + "Formats[@numberSystem = '" + numberSystemId + "']/" + formatType + "FormatLength[@type='" + length + "']/" + formatType + "Format/pattern").forEach(function (patternNode) {
            ...
            find("/ldml/numbers/" + formatType + "Formats[@numberSystem = '" + numberSystemId + "']/unitPattern").forEach(function (unitPatternNode) {
            ...
            .seq(function (prioritizedDocuments) {
                ...
                if (options.numbers) {
                    ...
                    (Array.isArray(options.numbers) ? options.numbers : Cldr.numberSystemIds).forEach(function (numberSystemId) {
                        localeData.numbers[numberSystemId] = that._extractNumberSystem(numberSystemId, find);
                    });
