...
describe('CldrPluralRule', function () {
    ...
    expect.addAssertion('<string> to encode to <string>', function (expect, subject, value) {
        expect(escodegen.generate(new CldrPluralRule(subject).toJavaScriptAst()), 'to equal', value);
    });
    ...
    it('should encode some assorted test cases correctly', function () {
        ...
        expect('n = 2..4', 'to encode to', 'n === Math.floor(n) && (n >= 2 && n <= 4)');
